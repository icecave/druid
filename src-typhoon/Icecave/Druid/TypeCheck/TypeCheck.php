...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\Druid\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\Druid\\TypeCheck'), false);
    }
